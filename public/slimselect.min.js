!(function(e, t) {
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			? define([], t)
			: 'object' == typeof exports ? (exports.SlimSelect = t()) : (e.SlimSelect = t());
})(window, function() {
	return ((s = {}),
	(n.m = i = [
		function(e, t, i) {
		...
		function(e, t, i) {
				...
				for (var e = 0, t = this.main.select.element.childNodes; e < t.length; e++) {
					...
					if ('OPTGROUP' === i.nodeName) {
						...
						'OPTION' === i.nodeName &&
							...
							this.data.push(l),
							l.placeholder && '' !== l.text.trim() && (this.main.config.placeholderText = l.text));
				}
			}),
			...
			(n.prototype.getSelected = function() {
				for (
					var e = { text: '', placeholder: this.main.config.placeholderText }, t = [], i = 0, s = this.data;
					i < s.length;
					i++
				) {
					var n = s[i];
			...
			function r(e) {
				return (
					void 0 !== e.text ||
					(console.error('Data object option must have at least have a text value. Check object: ' + JSON.stringify(e)),
					!1)
				);
			}
			(t.Data = s),
						...
						if (
							...
							'up' === this.config.showContent.toLowerCase()
								...
								: 'down' === this.config.showContent.toLowerCase()
									...
									: 'above' === l.putContent(this.slim.content, this.data.contentPosition, this.data.contentOpen)
										? this.moveContentAbove()
										: this.moveContentBelow(),
								...
								this.ajax &&
									this.ajax(t, function(e) {
										(i.config.isSearching = !1),
											Array.isArray(e)
												? (e.unshift({ text: '', placeholder: !0 }), i.setData(e), i.data.search(t), i.render())
					...
					'auto' === this.config.showContent &&
						window.addEventListener(
							...
							l.debounce(function(e) {
								t.data.contentOpen &&
									('above' === l.putContent(t.slim.content, t.data.contentPosition, t.data.contentOpen)
										? t.moveContentAbove()
										: t.moveContentBelow());
							}),
							!1,
			...
			var a = i(0),
				...
				(n.prototype.placeholder = function() {
					...
					if (null === e || (e && e.placeholder)) {
						...
						var i = '';
						e && (i = e.innerHTML && !0 !== this.main.config.valuesUseText ? e.innerHTML : e.text),
							this.singleSelected && (this.singleSelected.placeholder.innerHTML = e ? i : '');
					}
				}),
				...
				(n.prototype.values = function() {
					if (this.multiSelected) {
						for (
							var e, t = this.multiSelected.values.childNodes, i = this.main.data.getSelected(), s = [], n = 0, a = t;
							n < a.length;
							n++
						) {
							var o = a[n];
				...
				(n.prototype.valueDiv = function(a) {
					...
					t.classList.add(this.main.config.valueText),
						(t.innerHTML = a.innerHTML && !0 !== this.main.config.valuesUseText ? a.innerHTML : a.text),
						e.appendChild(t);
					var i = document.createElement('span');
					return (
						...
						(s.onkeyup = function(e) {
							...
							if ('Enter' === e.key) {
								...
								'ArrowUp' === e.key ||
									...
									('Escape' === e.key
										? n.main.close()
										: n.main.config.showSearch && n.main.data.contentOpen ? n.main.search(t.value) : (s.value = ''));
							e.preventDefault(), e.stopPropagation();
						}),
						(s.onfocus = function() {
							n.main.open();
						...
						this.main.addable &&
							...
							(a.onclick = function(e) {
								if (n.main.addable) {
									...
									if (!i) return;
									'object' == typeof i
										? o.validateOption(i) && (n.main.addData(i), (s = i.value ? i.value : i.text))
										: (n.main.addData(n.main.data.newOption({ text: i, value: i })), (s = i)),
										n.main.search(''),
										setTimeout(function() {
				...
				(n.prototype.option = function(r) {
					...
					t.addEventListener('click', function(e) {
						...
						if (!0 === r.selected && d.main.config.allowDeselectOption) {
							var i = !1;
							if (
								((d.main.beforeOnChange && d.main.config.isMultiple) || (i = !0),
					...
					return (
						(r.disabled || i) &&
							((t.onclick = null),
							d.main.config.allowDeselectOption || t.classList.add(this.main.config.disabled),
							d.main.config.hideSelectedOption && t.classList.add(this.main.config.hide)),
