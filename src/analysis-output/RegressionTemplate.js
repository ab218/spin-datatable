    ...
    temp.push(
      <tr key={i}>
        <td className="header-background">
          {centered ? `(${xLabel} - ${xMean.toFixed(4) / 1})` : xLabel}^
          {counter}
        </td>
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <table>
          <tbody>
            ...
            <tr>
              <td className="header-background large">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="small right">
              {(mse_model / mse_error).toFixed(2) / 1}
            </td>
