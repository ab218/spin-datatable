...
export default function OnewayAnalysis({ data, setPopup }) {
  ...
  const title = `Oneway Analysis of ${colY.label} ${
      ...
      <div id="popupcontainer" style={{ textAlign: "center" }}>
        ...
        <div style={{ display: "flex" }}>
          ...
          >
            ...
            {ordered_differences_report && (
              <OrderedDifferencesReport
                ordered_differences_report={ordered_differences_report}
              />
            )}
          </div>
        </div>
      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td className="right small">
              {anova.sum_sq.Residual.toFixed(4) / 1}
            </td>
            <td className="right small">
              {anova.mean_sq.Residual.toFixed(4) / 1}
            </td>
            <td className="right small" />
            <td className="right small" />
          </tr>
          <tr>
            ...
            <td className="right small">
              {(anova.sum_sq.x + anova.sum_sq.Residual).toFixed(4) / 1}
            </td>
            <td className="right small" />
            <td className="right small" />
            <td className="right small" />
