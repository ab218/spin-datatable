...
// // 				key: 'value',
// // 				type: 'number',
// // 				aliases: [ 'count', 'percentage', 'ratio' ],
// // 			},
// // 			{
// // 				key: 'series',
// // 				type: 'string',
...
// 	var colors = d3.scaleOrdinal().range(colorScheme);
// 	if (coloring === 'row') {
// 		colors.domain(rows);
...
// 		var g = svg.select('.container').attr('transform', d3.translate(margin.left, margin.top));
